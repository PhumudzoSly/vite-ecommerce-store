              ...
              <div className="grid grid-cols-2 gap-3">
                {categoryPreview.map(({ label, emoji }) => (
                  <a
                    key={label}
                    href={`/categories`}
                    className="flex items-center gap-3 rounded-xl border border-border bg-background px-4 py-3.5 text-sm font-medium text-foreground hover:bg-muted transition-colors"
                  >
