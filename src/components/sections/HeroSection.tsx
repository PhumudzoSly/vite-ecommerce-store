        ...
        <div className="grid min-h-[520px] grid-cols-1 items-center gap-16 py-20 lg:grid-cols-2 lg:py-24">
          ...
          <div className="flex flex-col items-start gap-6">
            ...
            <p className="max-w-sm text-base leading-relaxed text-muted-foreground">
              Browse thousands of curated products across electronics, fashion and more — fast shipping and easy returns included.
            </p>
          ...
          <div className="hidden lg:block">
            <Card className="bg-muted/40 p-2">
              <CardHeader className="pb-4">
                <CardTitle className="text-xs font-medium uppercase tracking-widest text-muted-foreground">Shop by category</CardTitle>
              </CardHeader>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {categoryPreview.map(({ label, emoji }) => (
                    <a
                      key={label}
                      href={`/categories`}
                      className="flex items-center justify-center gap-3 rounded-xl border border-border bg-background px-4 py-3.5 text-sm font-medium text-foreground hover:bg-muted transition-colors"
                    >
