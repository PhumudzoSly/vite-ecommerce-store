    ...
    <div className="flex flex-col">
      ...
      <div className="container mx-auto px-4 max-w-6xl -mt-16 pb-24">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {categories.map((c, i) => (
            <div key={i} className="bg-card p-8 rounded-2xl border shadow-sm hover:border-primary transition-all cursor-pointer group">
              ...
              <p className="text-xs font-semibold text-primary mb-3 uppercase tracking-wider">{c.count}</p>
        ...
        <section className="mt-20">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="p-5 rounded-xl border bg-card hover:bg-muted/50 cursor-pointer flex items-center justify-between group transition-colors">
